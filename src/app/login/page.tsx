...
export default function LoginPage() {
  const { signInWithEmail, signInWithPhone, confirmOtp, user, loading: authLoading } = useAuth();
  ...
  if (authLoading || user) { // Show loader if auth state is loading or if user is already logged in (and redirecting)
    return (
